...
function Show-Menu {
    ...
    Write-Host "  11. Battery Report (Notebook)" -ForegroundColor Yellow
    Write-Host "  12. BitLocker Information" -ForegroundColor Yellow
    Write-Host "  13. WiFi Passwords" -ForegroundColor Yellow
    Write-Host ""
...
function Get-BatteryReport {
    ...
    try {
        ...
        if (Test-Path $outputPath) {
            ...
            Write-Host ""
            Write-Host "Open this file in a web browser to view detailed battery history." -ForegroundColor Gray
        }
    } catch {
...
function Main {
    do {
        ...
        switch ($choice) {
            ...
            "10" { Get-SerialInfo }
            "11" { Get-BatteryReport }
            "12" { Get-BitLockerInfo }
            "13" { Get-WiFiPasswords }
            "0" {
